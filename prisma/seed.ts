...
async function main() {
    ...
    const startMissions = [
        ...
        { text: "Prendre le sort d'invocateur Soin",                                                          type: "START", category: "Sort",        difficulty: "easy", points: 100, isPrivate: false },
        { text: "Prendre le sort d'invocateur Clarté",                                                          type: "START", category: "Sort",        difficulty: "easy", points: 100, isPrivate: false },
        { text: "Prendre les sorts d'invocateur Soin et Clarté",                                                          type: "START", category: "Sort",        difficulty: "medium", points: 200, isPrivate: false },
        ...
        { text: "Acheter seulement des anneaux de Doran en début de partie",                       type: "START", category: "Handicap",    difficulty: "easy", points: 100, isPrivate: false  },
        { text: "Acheter seulement des lames de Doran en début de partie",                       type: "START", category: "Handicap",    difficulty: "easy", points: 100, isPrivate: false  },
        { text: "Acheter seulement des dagues en début de partie",                       type: "START", category: "Handicap",    difficulty: "easy", points: 100, isPrivate: false  },
        { text: "Acheter seulement des poussières luisantes en début de partie",                       type: "START", category: "Handicap",    difficulty: "easy", points: 100, isPrivate: false  },
        { text: "Acheter seulement des armures d'étoffe en début de partie",                       type: "START", category: "Handicap",    difficulty: "easy", points: 100, isPrivate: false  },
        { text: "Acheter seulement des épées longues en début de partie",                       type: "START", category: "Handicap",    difficulty: "easy", points: 100, isPrivate: false  },
        { text: "Acheter seulement des capes de néant en début de partie",                       type: "START", category: "Handicap",    difficulty: "easy", points: 100, isPrivate: false  },
        { text: "Acheter seulement des cristal de rubis en début de partie",                       type: "START", category: "Handicap",    difficulty: "easy", points: 100, isPrivate: false  },
        { text: "Acheter seulement des larmes de la déesse en début de partie",                       type: "START", category: "Handicap",    difficulty: "easy", points: 100, isPrivate: false  },
        { text: "Acheter seulement des cristal de saphir en début de partie",                       type: "START", category: "Handicap",    difficulty: "easy", points: 100, isPrivate: false  },
        { text: "Acheter seulement des charmes féérique en début de partie",                       type: "START", category: "Handicap",    difficulty: "easy", points: 100, isPrivate: false  },
        { text: "Acheter seulement des collier rafraîchissants en début de partie",                       type: "START", category: "Handicap",    difficulty: "easy", points: 100, isPrivate: false  },
        { text: "Acheter seulement des tomes d'amplification en début de partie",                       type: "START", category: "Handicap",    difficulty: "easy", points: 100, isPrivate: false  },
        { text: "Acheter seulement des potions en début de partie",                       type: "START", category: "Handicap",    difficulty: "easy", points: 100, isPrivate: false  },
        { text: "Acheter seulement des bottes en début de partie",                       type: "START", category: "Handicap",    difficulty: "easy", points: 100, isPrivate: false  },
    ...
    const midMissions = [
        ...
        // 🔒 Missions secrètes
        { text: "Insulter et provoquer l'équipe adverse en vocal",                       type: "MID", category: "Toxic",       difficulty: "easy", points: 100, isPrivate: true },
    ...
    const lateMissions = [
        ...
        { text: "Danser sur le cadavre de chaque ennemi tué et chanter Billie Jean",                                     type: "LATE", category: "Toxic",          difficulty: "easy",   points: 100, isPrivate: true  },
