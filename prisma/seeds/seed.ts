...
async function main() {
    ...
    const startMissions = [
        ...
        { text: "Acheter un maximum l'objet Larme de la déesse en début de partie. Vente autorisée après avoir pris un kill",                       type: "START", category: "Handicap",    difficulty: "medium", points: 200, isPrivate: false, maps: "all"  },
