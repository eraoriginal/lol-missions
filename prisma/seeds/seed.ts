...
async function main() {
    ...
    const startMissions = [
        ...
        { text: "Acheter un maximum l'objet Botte en début de partie. Vente autorisée après avoir pris un kill",                       type: "START", category: "Handicap",    difficulty: "medium", points: 200, isPrivate: false, maps: "all"  },
    ...
    const midMissions = [
        ...
        { text: "Revends tes items et achète uniquement des objets défensifs jusqu'à la fin",                            type: "MID", category: "Build",        difficulty: "medium", points: 200, isPrivate: false, maps: "all" },
        ...
        { text: "Revends tes items et achète uniquement des objets AP jusqu'à la fin",                        type: "MID", category: "Build",        difficulty: "medium", points: 200, isPrivate: false, maps: "all" },
        { text: "Revends tes items et achète uniquement des objets AD jusqu'à la fin",                        type: "MID", category: "Build",        difficulty: "medium", points: 200, isPrivate: false, maps: "all" },
        { text: "Revends tes items et achète uniquement des objets de vitesse d'attaque",                    type: "MID", category: "Build",        difficulty: "medium", points: 200, isPrivate: false, maps: "all" },
