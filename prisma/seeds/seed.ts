...
async function main() {
    ...
    const startMissions = [
        ...
        { text: "Finir la partie avec plus de 20 kills",                                          type: "START", category: "Combat",      difficulty: "hard", points: 500, isPrivate: false, maps: "all" },
        { text: "Ne pas mourir avant 5 minutes de jeu",                                           type: "START", category: "Survie",      difficulty: "easy",   points: 100, isPrivate: false, maps: "all" },
        { text: "Faire un pentakill",                                                             type: "START", category: "Combat",      difficulty: "hard",   points: 500, isPrivate: false, maps: "all" },
        { text: "Faire un quadrakill",                                                            type: "START", category: "Combat",      difficulty: "hard",   points: 500, isPrivate: false, maps: "all" },
        { text: "Finir avec le plus de dégâts de ton équipe",                                     type: "START", category: "Combat",      difficulty: "hard",   points: 500, isPrivate: false, maps: "all" },
        { text: "Finir avec le moins de dégâts de ton équipe",                                    type: "START", category: "Combat",      difficulty: "hard",   points: 500, isPrivate: false, maps: "all" },
        ...
        { text: "Faire un firstblood",                                                          type: "START", category: "Combat",        difficulty: "hard", points: 500, isPrivate: false, maps: "all" },
        { text: "Acheter un objet support en premier",                                      type: "START", category: "items",        difficulty: "medium", points: 200, isPrivate: false, maps: "all" },
        { text: "Finir la partie avec aucun sbire tué",                                      type: "START", category: "Handicap",        difficulty: "hard", points: 500, isPrivate: false, maps: "all" },
        ...
        { text: "Ne pas jouer avec ni Flash ni Fantôme",                                                          type: "START", category: "Sort",        difficulty: "hard", points: 500, isPrivate: false, maps: "all" },
        ...
        { text: "Mourir exactement 7 fois, ni plus ni moins",                                     type: "START", category: "Précision",   difficulty: "hard",   points: 500, isPrivate: false, maps: "all"  },
        { text: "Mourir exactement 8 fois, ni plus ni moins",                                     type: "START", category: "Précision",   difficulty: "hard",   points: 500, isPrivate: false, maps: "all"  },
        { text: "Mourir exactement 9 fois, ni plus ni moins",                                     type: "START", category: "Précision",   difficulty: "hard",   points: 500, isPrivate: false, maps: "all"  },
        ...
        // 🔒 Missions secrètes
        { text: "Acheter uniquement des objets qui commencent par la lettre de ton champion (hors bottes)",     type: "START", category: "items",        difficulty: "hard", points: 500, isPrivate: true, maps: "all" },
        { text: "Acheter les mêmes items qu'un adversaire unique pendant toute la partie",                                      type: "START", category: "items",        difficulty: "hard", points: 500, isPrivate: true, maps: "all" },
        { text: "Ne pas faire plus de 7 kills",                                     type: "START", category: "Précision",   difficulty: "hard",   points: 500, isPrivate: true, maps: "all"  },
        ...
        { text: "Avoir le plus de morts de la partie. Tu ne dois pas être à égalité avec un autre joueur",                                     type: "START", category: "Précision",   difficulty: "hard",   points: 500, isPrivate: true, maps: "all"  },
        { text: "Avoir le moins de morts de la partie. Tu ne dois pas être à égalité avec un autre joueur",                                     type: "START", category: "Précision",   difficulty: "hard",   points: 500, isPrivate: true, maps: "all"  },
        { text: "Faire danser tout le monde en début de partie",                                     type: "START", category: "Précision",   difficulty: "hard",   points: 500, isPrivate: true, maps: "all"  },
    ...
    const midMissions = [
        ...
        { text: "Acheter un élixir et ne jamais l'utiliser",                       type: "MID", category: "Survie",       difficulty: "hard", points: 500, isPrivate: false, maps: "all" },
        ...
        { text: "Ne pas mourir pendant 5 minutes, tu dois annoncer la mission en vocal",        type: "MID", category: "Survie",        difficulty: "hard", points: 500, isPrivate: false, maps: "all" },
        { text: "Se faire exécuter d'ici la fin de la partie, tu dois annoncer la mission en vocal",        type: "MID", category: "Suicide",        difficulty: "hard", points: 500, isPrivate: false, maps: "all" },
        ...
        { text: "Utiliser ton ultime dès qu'il est disponible (+ ou - 5 secondes) jusqu'à la fin de la partie",                       type: "MID", category: "Handicap",    difficulty: "hard", points: 500, isPrivate: true, maps: "all"  },
    ...
    const lateMissions = [
        ...
        { text: "Tu ne peux pas avoir plus de 5 items",                        type: "LATE", category: "Build",        difficulty: "hard", points: 500, isPrivate: false, maps: "all" },
        ...
        { text: "Finir la partie avec exactement 69 de farm",                                     type: "LATE", category: "Précision",   difficulty: "hard",   points: 500, isPrivate: true, maps: "all"  },
        { text: "Finir la partie avec exactement 21 kills",                                     type: "LATE", category: "Précision",   difficulty: "hard",   points: 500, isPrivate: true, maps: "all"  },
        ...
        { text: "Annoncer un plan catastrophique et l'exécuter. Ton équipe doit se faire ACE", type: "LATE", category: "Combat", difficulty: "hard", points: 500, isPrivate: true, maps: "all" },
