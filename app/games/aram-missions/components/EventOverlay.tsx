        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/90 backdrop-blur-md">
            <div className="w-full max-w-lg px-4 text-center">
                ...
                <div className="mb-6">
                    ...
                    <h2 className="text-3xl font-bold uppercase tracking-wider text-orange-400">
                        Événement Spécial
                    </h2>
                </div>

                {/* Event card */}
                <div className="bg-gradient-to-br from-orange-900/60 to-orange-950/60 border-2 border-orange-500/50 rounded-xl p-8 shadow-lg shadow-orange-500/20">
                    ...
                    <div className="flex items-center justify-center gap-3">
                        ...
                        <span className="text-sm font-bold text-orange-300 bg-orange-900/50 px-3 py-1 rounded border border-orange-500/30">
                ...
                <div className="mt-6 space-y-3">
                    ...
                    <button
                        ...
                        className="px-8 py-3 bg-orange-600 hover:bg-orange-700 text-white font-bold rounded-lg transition-all text-lg"
                    >
                        Compris
                    </button>
                </div>
